...
const dict = {
  ...
  stockMethodNote: { ar: "الطريقة: سرعة البيع = نسخ مباعة ÷ الفترة. الطلب المتوقع = السرعة × (التغطية + مهلة التوريد). المقترح = المتوقع − المخزون الحالي.", en: "Method: velocity = units sold ÷ period. Projected = velocity × (cover + lead time). Suggested = projected − current stock." },
  // Targets
